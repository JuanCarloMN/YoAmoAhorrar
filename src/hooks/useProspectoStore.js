    ...
    const startConvierteProspecto = async ( prospecto ) => {
        try {
            const datosCliente = {
                ...
                clienteEstadoCivil: prospecto.prospectoEstadoCivil,
                clienteSexo: prospecto.prospectoSexo,
                clienteEscolaridad: prospecto.prospectoEscolaridad,
                ...
                clienteEmpresa: prospecto.prospectoEmpresa,
                clientePuesto: prospecto.prospectoPuesto,
                clienteAntiguedad: prospecto.prospectoAntiguedad,
                clienteActividades: prospecto.prospectoActividades,
                clienteConyugue: prospecto.prospectoConyugue,
                clienteNumeroHijos: prospecto.prospectoNumeroHijos,
                clienteTipoVivienda: prospecto.prospectoTipoVivienda,
                clientePasatiempo: prospecto.prospectoPasatiempo,
                clienteMascotas: prospecto.prospectoMascotas,
                clienteDeporte: prospecto.prospectoDeporte,
