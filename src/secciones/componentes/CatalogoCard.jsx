...
export const CatalogoCard = ( { tipo = 0, datos = [] } ) => {
    ...
    return (
        ...
        <div className="card-body">
                ...
                <div className="accordion-item">
                    <div className="accordion-header" id={ `seccion${ catalogo( tipo ) }` }>
                        <button 
                            ...
                            data-bs-target={`#contenido${ catalogo( tipo ) }`}
                            aria-expanded="true"
                            aria-controls={ `contenido${ catalogo( tipo ) }` }
                        >
            ...
            <div
                id={ `contenido${ catalogo( tipo ) }` }
                className="accordion-collapse collapse"
                aria-labelledby={ `seccion${ catalogo( tipo ) }` }
                data-bs-parent="#catalogos"
            >
