                ...
                <div className="card-group ">
                    <div className="card col-12 col-lg-3">
                        <div className="card-body text-center">
                            <h4>Depósito <br />inicial</h4>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="100" height="100" fill="#d12525ff">
                            ...
                            <h3>{ formatoMoneda( ( isNaN( totales.deposito ) ? 0 : totales.deposito ) ) }</h3>
                        </div>
                    </div>
                    <div className="card ">
                        <div className="card-body text-center">
                            <h4 className="no-salto">Aportaciones<br />acumuladas</h4>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="100" height="100" fill="#2e0ee4ff">
                            ...
                            <h3>{ formatoMoneda( ( isNaN(totales.aportacion) ? 0 : totales.aportacion ) ) }</h3>
                        </div>
                    </div>
                    <div className="card ">
                        <div className="card-body text-center">
                            <h4>Interés <br />acumulado</h4>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="100" height="100" fill="#77ba86ff">
                            ...
                            <h3>{ formatoMoneda( ( isNaN( totales.interes ) ? 0 : totales.interes ) ) }</h3>
                        </div>
                    </div>
                    <div className="card pregunta-test">
                        <div className="card-body text-center">
                            <h4>Total <br />acumulado</h4>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="100" height="100" fill="#542052">
                            ...
                            <h3>{ formatoMoneda( ( isNaN( totales.total ) ? 0 : totales.total ) ) }</h3>
                        </div>
                    </div>
                </div>
            </div>
