            ...
            <div className="container-fluid p-4">
                <div className="row ">
                    <div className="col-12 d-flex justify-content-between align-items-center">
                        <h1 className="mt-2">Reportes</h1>

                    </div>
                    <div className="row d-flex content-justify-between p-2">
                        <div className="col-3 card">
                            <h5 className="card-header border-dark">Cumpleaños</h5>
                        ...
                        <div className="col-3 card">
                            <h5 className="card-header border-dark">Renovación de pólizas</h5>
                            <div className="card-body border-dark">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000">
