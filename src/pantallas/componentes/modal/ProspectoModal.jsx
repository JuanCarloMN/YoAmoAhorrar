        ...
        >
            <form className="container" onSubmit={ onSubmit }>
                ...
                <div className="container border p-3">
                    <div className="accordion accordion-flush " id="prospecto">
                        <div className="accordion-item border mb-2">
                            ...
                            <div id="datosBasicos" className="accordion-collapse collapse show p-0" data-bs-parent="#prospecto">
                        ...
                        <div className="accordion-item border mb-2">
                            ...
                            <div id="datosContacto" className="accordion-collapse collapse" data-bs-parent="#prospecto">
                                <div className="accordion-body">
                        ...
                        <div className="accordion-item border mb-2">
                            ...
                            <div id="datosInteres" className="accordion-collapse collapse" aria-labelledby="seccionInteres" data-bs-parent="#prospecto">
                                <div className="accordion-body">
                        ...
                        <div className="accordion-item border mb-2">
                            ...
                            <div id="datosOtros" className="accordion-collapse collapse" data-bs-parent="#prospecto">
                                <div className="accordion-body">
                                    <div className="form-group d-flex justify-content-between align-items-end">
                                        <div className="form-item me-3 col-6 ">
                                            <div className="form-item mb-2 ">
