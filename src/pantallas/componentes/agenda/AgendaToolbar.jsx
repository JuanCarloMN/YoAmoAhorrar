            ...
            <div className="d-flex">
                <div className="col flex-fill text-start">
                    <div className="btn-group">
                        <button className="btn btn-outline-secondary" onClick={ () => cambiaFecha( 1 ) }>
                            Hoy
                        </button>
                        <button className="btn btn-outline-secondary" onClick={ () => cambiaFecha( 2 ) }>
                        ...
                        <button className="btn btn-outline-secondary" onClick={ () => cambiaFecha( 3 ) }>
                ...
                <div className="col flex-fill text-center bg-light">
                    <div className="btn-group">
                        <button className={`btn btn-outline-secondary ${ tipoActual[0] }`} onClick={ () => cambiaTipo( 0 ) }>
                            Todos
                        </button>
                        <button className={`btn btn-outline-secondary ${ tipoActual[1] }`} onClick={ () => cambiaTipo( 1 ) }>
                        ...
                        <button className={`btn btn-outline-secondary ${ tipoActual[2] }`} onClick={ () => cambiaTipo( 2 ) }>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="icono-agenda" viewBox="0 0 16 16">
                        ...
                        <button className={`btn btn-outline-secondary ${ tipoActual[3] }`} onClick={ () => cambiaTipo( 3 ) }>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="icono-agenda" viewBox="0 0 16 16">
                        ...
                        <button className={`btn btn-outline-secondary ${ tipoActual[4] }`} onClick={ () => cambiaTipo( 4 ) }>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="icono-agenda" viewBox="0 0 16 16">
                                <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2z"/>
                                <path d="M7 5.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5m-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0M7 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5m-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0"/>
                            </svg>
                        </button>
                        <button className={`btn btn-outline-secondary ${ tipoActual[5] }`} onClick={ () => cambiaTipo( 5 ) }>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="icono-agenda" viewBox="0 0 16 16">
                ...
                <div className="col flex-fill text-end">
                    <div className="btn-group">
                        <button className={`btn btn-outline-secondary ${ vistaActual[0]}`} onClick={ () => enviaVista( 'month' ) }>
                            Mes
                        </button>
                        <button className={`btn btn-outline-secondary ${ vistaActual[1]}`} onClick={ () => enviaVista( 'week' ) }>
                            Semana
                        </button>
